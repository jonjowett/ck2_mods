...
NDiplomacy = {
	...
	VASSAL_LIMIT_KING_MULT = 35.0, 				-- Extra Vassal Limit from the ruler's rank
	...
	CONCLAVE_VASSAL_LIMIT_DUKE_MULT = 10.0, 				-- Extra Vassal Limit from the ruler's rank
	CONCLAVE_VASSAL_LIMIT_KING_MULT = 25.0, 				-- Extra Vassal Limit from the ruler's rank
	CONCLAVE_VASSAL_LIMIT_EMPEROR_MULT = 35.0, 			-- Extra Vassal Limit from the ruler's rank
	CONCLAVE_VASSAL_LIMIT_GREAT_DUKE_BONUS = 5.0, 		-- Extra Vassal Limit for Dukes with more than one Duchy

	OBJECTIVE_DISCARD_WEIGHT_THRESHOLD = 0.1,					-- AI will not pick ambitions or plots below this evaluated weight
	MAX_DUCHIES_LEGALLY_HELD = 3,								-- Max duchies that a king or above can hold before vassals start getting angry
	MAX_ELECTOR_TITLES_LEGALLY_HELD = 2,						-- Max elector titles that a king or above can hold before vassals start getting angry
	...
	ASK_FOR_DIVORCE_INTERACTION_PIETY = 50,
	...
	ASK_FOR_MONEY_INTERACTION_THRESHOLD_FOR_NO = 25,
	ASK_FOR_MONEY_INTERACTION_THRESHOLD_FOR_YES = 100,
	...
	ASK_FOR_CRUSADE_INTERACTION_THRESHOLD_FOR_NO = 25,
	ASK_FOR_CRUSADE_INTERACTION_THRESHOLD_FOR_YES = 100,
	...
	NOMINATE_BISHOP_TO_POPE_INTERACTION_THRESHOLD_FOR_NO = 25,
	NOMINATE_BISHOP_TO_POPE_INTERACTION_THRESHOLD_FOR_YES = 100,
	...
	ARTIFACT_VALUE_OPINION_MULT = 5.0,								-- Multiplied with Artifact Quality
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	DE_JURE_ASSIMILATION_YEARS = 300,			-- Duchies a under the de facto control of another kingdom will change de jure liege after this many years
	EMPIRE_DE_JURE_ASSIMILATION_YEARS = 300,	-- Kingdoms under the de facto control of another empire will change de jure liege after this many years
	
	GAME_RULES_DEJURE_LONG = 500,
	GAME_RULES_DEJURE_LONG_EMPIRE = 500,

	GAME_RULES_DEJURE_SHORT = 150,
	GAME_RULES_DEJURE_SHORT_EMPIRE = 150,
	
	GAME_RULES_DEJURE_SHORTEST = 100,
	GAME_RULES_DEJURE_SHORTEST_EMPIRE = 100,
...
NMilitary = {
	...
	HOLDING_LEVY_SIZE_OWNER_MARTIAL_BASE = 0.75,	
	...
	TOTAL_OCCUPATION_SCALE = 0.85,					-- The % of occupation which gives you 100% warscore
	...
	LOOTED_MODIFIER_MONTHS = 12,					-- How long pagan looting lasts
	...
	SETTLED_ADVENTURER_MODIFIER_YEARS = 25,			-- How long provinces are spared from raiding after settling a raider adventurer.
	...
	COMMAND_MODIFIER_MARTIAL_MULTIPLIER = 0.02,	  -- How much positive command modifiers are increased, and negative modifiers decreased (capped to 100% for negative), per point of martial
	...
	SHATTERED_RETREAT_MOVEMENT_MULTIPLIER = 2,-- Multiplier of unit movement speed when shattered
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 3370,				-- Set this to your earliest starting year
	...
	IDEAL_YEAR_LEVEL_0 = 3300, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 4350,
...
NDisease = {
	...
	INFECTION_CHANCE_COASTAL_SEAS_ARE_COUNTED = 1,		-- Exclude coastal seas from the number of infected provinces (they still get infected but don't change the number of "real" provinces that get infected each tick)
...
NEngine = {
	EVENT_PROCESS_OFFSET = 30,				-- Events are checked every X day per character or province (1 is ideal, but CPU heavy). Max value of 255
	COURTIER_EVENT_PROCESS_OFFSET = 255,		-- Events are checked every X day for courtiers. Max value of 255
	COURTIERS_MTTTH_EVENTS = 1,				-- Toggles if courtiers are allowed to run MTTH events or not
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_YEAR = 4000, -- The missing scripted successor error will not be shown before this date
...
NAI =
{
	...
	NAVAL_INVASION_RANGE = 500,								-- Factor which increase AI invasion range if set higher
	...
	RAID_MAX_REALM_SIZE = 64,								-- Realms with more holdings than this will never go on Raids
	RAID_AGGRESSION = 10,									-- General frequency of raids. A LOWER number means more often!
	...
	RAISE_FORCES_ENEMY_TROOP_AMOUNT	= 0.95,					-- Threshold that checks if AI should employ holy order or raise controlled/uncontrolled landless forces if AI has less troops than threshold multiplied by raised enemy troop
...
NFrontend = 
{
	...
	MAX_ZOOM_LEVEL = 3000,				-- How far out the player can zoom. Warning: At very high zoom levels, the ground will no longer render
