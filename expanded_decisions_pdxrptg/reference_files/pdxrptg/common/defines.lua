...
NEngine = {
	EVENT_PROCESS_OFFSET = 21,				-- Events are checked every X day per character or province (1 is ideal, but CPU heavy). Max value of 255
	...
	COURT_PRUNE_SIZE = 12,					-- Courts larger than this will be checked for pruning each month
